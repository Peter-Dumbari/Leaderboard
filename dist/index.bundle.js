...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addScore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addScore.js */ \"./src/modules/addScore.js\");\n/* harmony import */ var _modules_BaseUrl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/BaseUrl */ \"./src/modules/BaseUrl.js\");\n\n\n\n\nconst ul = document.querySelector(\".recent_scores_ul\");\nconst form = document.querySelector(\"form\");\nconst refresh = document.querySelector(\".refresh_btn\");\nconst submit = document.querySelector(\"#submit\");\nlet gameId;\n\nform.addEventListener(\"submit\", async (e) => {\n  e.preventDefault();\n  const name = document.getElementById(\"name\");\n  const score = document.getElementById(\"score\");\n  const $name = name.value;\n  const $score = score.value;\n  await (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_1__.addScore)($name, $score, gameId);\n\n  name.value = \"\";\n  score.value = \"\";\n});\n\nconst addGame = async () => {\n  const storedGameId = localStorage.getItem(\"Id\");\n  if (storedGameId) {\n    gameId = storedGameId;\n  } else {\n    const response = await fetch(`${_modules_BaseUrl__WEBPACK_IMPORTED_MODULE_2__[\"default\"]}games/`, {\n      method: \"POST\",\n      headers: {\n        \"Content-Type\": \"application/json\",\n      },\n      body: JSON.stringify({ name: \"My cool new game\" }),\n    });\n    const data = await response.json();\n    const iDmessage = data.result;\n    const id = iDmessage.match(/ID: (\\w+)/)[1];\n    localStorage.setItem(\"Id\", id);\n    console.log(\"it also done from here\");\n  }\n};\naddGame();\n\nrefresh.addEventListener(\"click\", async () => {\n  const scores = await (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_1__.getGame)(gameId);\n  console.log(scores);\n  ul.innerHTML = \"\";\n  scores.forEach((score) => {\n    const li = (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_1__.recentScores)(score.user, score.score);\n    ul.appendChild(li);\n  });\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst BASE_API_URL =\n  \"https://us-central1-js-capstone-backend.cloudfunctions.net/api/\";\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BASE_API_URL);\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/BaseUrl.js?");
